...
class RuleDescViewCtr(object):
	"""docstring for RuleDescViewCtr"""
	def __init__(self, parent, params = {}):
		super(RuleDescViewCtr, self).__init__();
		self._className_ = RuleDescViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = RuleDescViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
