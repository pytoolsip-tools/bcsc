...
from BinaryConversionViewUI import *;
...
class BinaryConversionViewCtr(object):
	"""docstring for BinaryConversionViewCtr"""
	def __init__(self, parent, params = {}):
		super(BinaryConversionViewCtr, self).__init__();
		self._className_ = BinaryConversionViewCtr.__name__;
	...
	def initUI(self, parent, params):
		# 创建视图UI类
		self.__ui = BinaryConversionViewUI(parent, curPath = self._curPath, viewCtr = self, params = params);
		self.__ui.initView();
